...
int serial_ll_reset_device(usart_t self);
int serial_ll_power_enable(usart_t self);
int serial_ll_init(usart_t self, uint32_t baudrate);
int serial_ll_wait_for_tx_ready(usart_t self);
int serial_ll_wait_for_rx_ready(usart_t self);
int serial_ll_write_byte(usart_t self, uint8_t byte);
